...
const bulletin_schema_1 = require("./schemas/bulletin.schema");
let PayrollModule = class PayrollModule {
};
exports.PayrollModule = PayrollModule;
exports.PayrollModule = PayrollModule = __decorate([
    (0, common_1.Module)({
        imports: [mongoose_1.MongooseModule.forFeature([{ name: bulletin_schema_1.Bulletin.name, schema: bulletin_schema_1.BulletinSchema }])],
