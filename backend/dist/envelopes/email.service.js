...
let EmailService = EmailService_1 = class EmailService {
    ...
    async sendSignatureRequestEmail(envelope, recipient) {
    ...
    async sendEnvelopeCompletedEmail(envelope, recipient) {
    ...
    async sendEnvelopeRefusedEmail(envelope, recipient, refusingRecipient) {
        const emailContent = {
            to: recipient.email,
    ...
    async sendEnvelopeRefusedNotificationToCreator(envelope, refusingRecipient) {
